...
Options:
    ...
    --checkbox_ppas             sanity-3 parameter checkbox_ppas, default is ppa:checkbox-dev/beta ppa:oem-solutions-group/pc-sanity-daily ppa:firmware-testing-team/ppa-fwts-stable
